...
unsigned char pid[] = {"lhtwmz7h63b35ndm"};//*********处替换成涂鸦IoT平台自己创建的产品的PID
unsigned char mcu_ver[] = {"1.0.0"};

unsigned long last_time = 0;
SoftwareSerial DebugSerial(13,15);
void setup() {
    ...
    if(newState1 == LOW) {      // Yes, still low
      ...
      switch(mode) {           // Start the new animation...
        case 0:
          ...
          break;
        case 1:
          theaterChase1(strip.Color(  0,  80, 127), 10); // Blue   
           theaterChase1(strip.Color(  80,  80, 127), 10); // Blue
            theaterChase1(strip.Color( 70,  200, 127), 10); // Blue
          break;
        case 2:
           theaterChase1(strip.Color(  100,   0, 127), 10); // Blue
            theaterChase1(strip.Color(  20,  80, 150), 10); // Blue 
             theaterChase1(strip.Color( 70,  100, 127), 10); // Blue 
          break;
        case 3:
           theaterChase1(strip.Color(  50,   120, 127), 10); // Blue
            theaterChase1(strip.Color(  100,  150, 225), 10); // Blue
             theaterChase1(strip.Color(  50,  80,180), 10); // Blue
          break;
...
void theaterChase1(uint32_t color, int wait) {
  for(int a=4; a<8; a++) {  // Repeat 10 times...
...
// Rainbow cycle along whole strip. Pass delay time (in ms) between frames.彩虹
...
// Rainbow-enhanced theater marquee. Pass delay time (in ms) between frames.剧院彩虹
    ...
    break;
     ...
     switch(scene_mode){
       case 0:
          ...
          break;
        case 1:
          colorWipe(strip.Color(150,   100,   0), 50);    // Red
          break;
        case 2:
        
          colorWipe(strip.Color(  0, 255,  100), 50);    // Green
          break;
        case 3:
          colorWipe(strip.Color( 150,   0, 255), 50);    // Blue
          break;
        case 4:
          theaterChase(strip.Color(127, 127, 127), 50); // White
          break;
